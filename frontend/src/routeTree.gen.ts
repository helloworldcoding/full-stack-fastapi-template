...
import { Route as LayoutArticlesImport } from './routes/_layout/articles'
...
const LayoutArticlesRoute = LayoutArticlesImport.update({
  path: '/articles',
  getParentRoute: () => LayoutRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_layout/articles': {
      preLoaderRoute: typeof LayoutArticlesImport
      parentRoute: typeof LayoutImport
    }
    '/_layout/items': {
